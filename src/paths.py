...
AGGREGATED_RIDES_DATA_PATH = PROCESSED_DATASET_DIR / "final_aggregated_rides_merged_test.csv"


TRUE_VALUES_PATH = RESULTS_DIR / "true_values.npy"
PREDICTIONS_PATH = RESULTS_DIR / "predictions.npy"
